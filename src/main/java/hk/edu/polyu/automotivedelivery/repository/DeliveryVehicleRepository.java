...
import hk.edu.polyu.automotivedelivery.model.DeliveryVehicle;
...
public class DeliveryVehicleRepository {
    ...
    public DeliveryVehicle findById(Integer vehicleId) {
        ...
        try (Connection conn = DBUtil.getConnection();
            ...
            throw new RuntimeException("Error finding delivery vehicle by id: " + e.getMessage(), e);
        }
        return null;
    }
    ...
    public List<DeliveryVehicle> findAll() {
        ...
        try (Connection conn = DBUtil.getConnection();
            ...
            throw new RuntimeException("Error fetching all delivery vehicles: " + e.getMessage(), e);
        }
        return result;
    }
